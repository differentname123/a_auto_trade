...
# origin_data_path = '../final_zuhe/min_data/2024-02-19_RF_target_thread.csv'
...
# temp_data1 = data1[(data1['日期'] == '2024-02-19') & (data1['收盘'] == 18.09) & (data1['代码'] == '600559')]
# temp_data = data[(data['日期'] == '2024-02-19 15:00:00') & (data['收盘'] == 18.09) & (data['代码'] == '600559')]
