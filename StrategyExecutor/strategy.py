...
if __name__ == "__main__":
    # # daily macd新低买入
    strategy('../daily_data_exclude_new/上海机电_600835.txt', gen_signal_func=gen_daily_buy_signal_seventeen,
    ...
    # 回测所有数据
    back_all_stock('../daily_data_exclude_new/', '../back', gen_signal_func=gen_daily_buy_signal_seventeen, backtest_func=backtest_strategy_highest_buy_all)
